...
public class User {
	...
	public User(@NotBlank(message = "Name can't be null.") String userName, String age,
			@NotBlank(message = "Email can't be null.") String email,
			@NotBlank(message = "Password can't be null.") String password, String setPref, boolean isActivate,
			List<Role> roleSet, List<Review> reviews) {
		super();
		this.userName = userName;
		this.age = age;
		this.email = email;
